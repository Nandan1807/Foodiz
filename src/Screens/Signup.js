        ...
        <>
            <div className="container">
                ...
                <form className="backform form" onSubmit={handleSubmit}>
                    ...
                    <label className="backlabel" for="name">User name</label>
                    <input className="backinput" type="text" placeholder="Username" id="username" required name="name" value={user.name} onChange={change} />

                    <label className="backlabel" for="Email">Email address</label>
                    ...
                    <label className="backlabel" for="Geolocation">Address</label>
                    <input className="backinput" type="text" placeholder="Geolocation" required name="geolocation" value={user.geolocation} onChange={change} />
